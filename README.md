...
Additionally, a reduction of the receipt images to a size of roughly 200 kB before being processed with easyocr was necessary to avoid ```easyocr.Reader.readtext``` to make streamlit crash when recognizing text from the images.
